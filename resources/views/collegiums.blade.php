...
selector:focus {outline: none;}
    ...
    <!-- <h1>Home</h1> -->
    <div class="row">
  <div class="col-md-4"><section class="card card-featured-left card-featured-primary mb-4">
									<button type="button"  data-toggle="modal" data-target="#Deçan" class="butoni"><div class="card-body">
